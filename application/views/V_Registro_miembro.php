...
<body>
	...
	<div class="container">
		...
		<?=form_open_multipart(base_url()."Guardar_Miembro")?>
		  ...
		  <div class="row">
		   ...
		   <div class="row">
			    ...
			    <div class="col-3">
			    	...
			    	<input type="text" class="form-control" placeholder="Clasificación" id="txtclas" name="txtclas" >
			    </div>
			    <div class="col-3">
			    	<label class="col-form-label">Ministerio: </label>
			    	<input type="text" class="form-control" placeholder="Ministerio" id="txtninis" name="txtminis" >
			    </div>
			</div>
			<br>
